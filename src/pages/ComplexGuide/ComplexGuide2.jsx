  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>송도역 한신더휴 프레스턴- 호수배치도</title>
        <meta
          name="description"
          content="송도역 한신더휴 프레스턴의 호수 배치도를 통해 각 세대의 위치와 전망을 확인하세요. 주거 만족도를 높이는 체계적인 배치 설계로 더 나은 라이프스타일을 제안합니다."
        />
    <meta name="keywords"
          ...
          {`
										{
											...
											"@type": "WebPage",
											"name": "송도역 한신더휴 프레스턴- 호수배치도",
											"description": "송도역 한신더휴 프레스턴의 호수 배치도를 통해 각 세대의 위치와 전망을 확인하세요. 주거 만족도를 높이는 체계적인 배치 설계로 더 나은 라이프스타일을 제안합니다.",
